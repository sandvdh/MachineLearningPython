...
if 'Plastic' in data_final.columns:
    ...
    report_df.to_csv("classification_report_combined_RFOpt.csv")
    print(report_df)
    ...
    misclassified_df.to_csv("misclassified_samples_combined_RFOpt"
                            ".csv", index=False)
    ...
    plt.title('Combined Lei and InHouse dataset - RF')
