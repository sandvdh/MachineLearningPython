...
# Train the SVM model
model = SVC(C=1.0, kernel='linear', gamma=0.1, random_state=0)
...
classification_report_df.to_csv('new_classification_report_Lei_SVM.csv', index=True)
print("Classification report saved as 'new_classification_report_Lei_SVM.csv'.")
