...
"""# Standardize the features (KNN requires feature scaling)
scaler = RobustScaler()  # You can also use RobustScaler if needed
...
# Set up GridSearchCV
grid_search = GridSearchCV(estimator=knn, param_grid=param_grid, cv=skf, scoring='accuracy', n_jobs=1, verbose=2)
...
# Use the best model found in grid search for predictions
